...
INSERT INTO "new_Memory" ("aiGenerated", "audioUrl", "capacity", "category", "content", "createdAt", "curationScore", "description", "documentUrl", "eventDate", "eventId", "id", "isEvent", "isPublic", "location", "mediaUrl", "organizationId", "tags", "ticketPrice", "title", "updatedAt", "userId") SELECT "aiGenerated", "audioUrl", "capacity", "category", "content", "createdAt", "curationScore", "description", "documentUrl", "eventDate", "eventId", "id", "isEvent", "isPublic", "location", "mediaUrl", "organizationId", "tags", "ticketPrice", "title", "updatedAt", "userId" FROM "Memory";
DROP TABLE "Memory";
